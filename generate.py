...
def main():
    ...
    parser.add_argument('--model_config', default='model/gpt2_ml/config.json', type=str, required=False, help='模型参数')
    parser.add_argument('--tokenizer_path', default='cache/vocab.txt', type=str, required=False, help='词表路径')
    parser.add_argument('--model_path', default='model/gpt2_ml', type=str, required=False, help='模型路径')
    parser.add_argument('--prefix', default='双十一', type=str, required=False, help='生成文章的开头')
